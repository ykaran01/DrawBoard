...
import { addElement, changeImage, createBoard, deleteBoard, getBoard, getMyBoards, joinBoard, updateBoard ,authoriseUser} from "../controllers/board.controller.js";
...
boardrouter.post('/authorise/:roomId',authoriseUser)
export { boardrouter }